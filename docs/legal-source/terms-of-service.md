...
- Stop using the App if you experience adverse effects
...
- We do not claim ownership of your workout or nutrition data
...
- Premium subscriptions may be offered
- Prices will be clearly displayed
- Subscriptions auto-renew unless cancelled
- Refund policy will be provided at time of purchase

## Data Usage and Privacy

Your use of the App is also governed by our Privacy Policy. By using the App, you consent to:
- Collection and use of information as described in Privacy Policy
...
- **Google/Apple**: Authentication (optional)

These services have separate terms and privacy policies. We are not responsible for their practices.

## Content Accuracy

While we strive for accuracy:
- Nutritional information may contain errors
- Workout recommendations are general guidance
- AI-generated plans are not personalized medical advice
...
### Class Action Waiver
You agree to resolve disputes on an individual basis and waive class action rights.
...
### Apple App Store
- You acknowledge Apple has no obligation to provide support
- Apple is not responsible for the App
- You comply with Apple's Media Services Terms

### Google Play Store
- You acknowledge Google has no obligation to provide support
...
- Users 13-17 must have parental consent
- Parents are responsible for minors' use

## Export Control

You agree to comply with export control laws and not export or re-export the App to prohibited countries or individuals.
...
- Email: ahmetsametyuzlu@gmail.com
