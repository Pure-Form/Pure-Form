      ...
      >
        <ScrollView contentContainerStyle={styles.scroll} keyboardShouldPersistTaps="handled">
          <View style={styles.header}>
            <Text style={[styles.headline, { color: theme.colors.text }]}>{t("auth.createAccount")}</Text>
            ...
            <View style={styles.row}>
              <View style={styles.half}>
                <FormTextInput
                  ...
                  value={form.heightCm}
                  onChangeText={(value: string) => handleInputChange("heightCm", value)}
              ...
              <View style={styles.half}>
                <FormTextInput
                  ...
                  keyboardType="number-pad"
                  value={form.weightKg}
                  onChangeText={(value: string) => handleInputChange("weightKg", value)}
                  error={errors.weightKg}
                />
              </View>
            </View>

            <Text style={[styles.label, { color: theme.colors.subText }]}>{t("auth.goal")}</Text>
          ...
          <View style={styles.footer}>
            <PrimaryButton title={t("auth.register")} onPress={handleSubmit} loading={loading} />
            <PrimaryButton
